...
public class Laadgegevens  implements java.io.Serializable {
     ...
     private Set<Oplegger> opleggers = new HashSet<Oplegger>(0);
    ...
    public Laadgegevens(int laadid, Double tarragewicht, Double laadvermogen, Double laadvolume, Double laadmeters, Double lengte, Double breedte, Double hoogte, Integer aantalassen, String motornorm, Set<Oplegger> opleggers) {
       this.laadid = laadid;
    ...
    public Set<Oplegger> getOpleggers() {
        return this.opleggers;
    }
    
    public void setOpleggers(Set<Oplegger> opleggers) {
        this.opleggers = opleggers;
    }
